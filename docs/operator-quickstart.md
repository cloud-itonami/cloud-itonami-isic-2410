# Operator Quickstart — Manufacture of Basic Iron and Steel

Shortest path from clone to a verified local dry-run for **ISIC 2410** (`cloud-itonami-isic-2410`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2410.git
cd cloud-itonami-isic-2410
```
...
- Blueprint governor key: `steelworks-governor`
- Likely source path: `steelworks.governor.cljc`
